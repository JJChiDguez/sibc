...
if setting.algorithm == 'csidh':
    from csidh.printstrategy import *

elif setting.algorithm == 'bsidh':
    from bsidh.printstrategy import *
...
for idx in range(0, len(S_out), 1):
    ...
    nx.draw(G, vertexes, node_color=['black']*len(vertexes), node_size=vertex_sizes, edge_color=edge_colors, width=weights, edge_labels=True)
