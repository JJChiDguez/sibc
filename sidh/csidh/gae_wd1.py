    ...
    for i in range(len(strategy)):
        ...
        if (
            ...
            if isinfinity(ramifications[-1]) == False:
                ...
                ramifications[-1][0], ramifications[0][0] = fp_cswap(
                    ramifications[-1][0], ramifications[0][0], b_i
                )
                ramifications[-1][1], ramifications[0][1] = fp_cswap(
                ...
                T[0], ramifications[0][0] = fp_cswap(
                    T[0], ramifications[0][0], b_i
                )
                T[1], ramifications[0][1] = fp_cswap(
                ...
                for j in range(1, len(moves) - 1, 1):
                    ...
                    T[0], ramifications[j][0] = fp_cswap(
                        T[0], ramifications[j][0], b_i
                    )
                    T[1], ramifications[j][1] = fp_cswap(
