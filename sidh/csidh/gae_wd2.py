...
for i in range(n):
    ...
    C[1][tuple([L[i]])] = (
        C_xISOG[i] - C_xMUL[i] + 2.0 * numpy.array([4.0, 2.0, 6.0])
    ...
    for i in range(len(strategy)):
        ...
        if (
            ...
            if isinfinity(ramifications[-1][0]) == False:
                ...
                ramifications[-1][0][0], ramifications[0][0][0] = fp_cswap(
                    ramifications[-1][0][0], ramifications[0][0][0], b_i
                )
                ramifications[-1][0][1], ramifications[0][0][1] = fp_cswap(
                ...
                if setting.formulaes != 'tvelu':
                    ...
                    if (
                        ...
                        T = xMUL(ramifications[-1][0], E_i, pos)
                ...
                if setting.formulaes == 'tvelu' or (
                    ...
                    ramifications[0][0] = xEVAL(ramifications[0][0], pos)
                    ramifications[0][1] = xEVAL(ramifications[0][1], pos)
                else:
                    ramifications[0][0] = xEVAL(ramifications[0][0], E_i)
                    ramifications[0][1] = xEVAL(ramifications[0][1], E_i)

                T[0], ramifications[0][0][0] = fp_cswap(
                    T[0], ramifications[0][0][0], b_i
                )
                T[1], ramifications[0][0][1] = fp_cswap(
                    T[1], ramifications[0][0][1], b_i
                )
                T_prime[0], ramifications[0][1][0] = fp_cswap(
                    T_prime[0], ramifications[0][1][0], b_i
                )
                T_prime[1], ramifications[0][1][1] = fp_cswap(
                ...
                for j in range(1, len(moves) - 1, 1):
                    ...
                    if setting.formulaes == 'tvelu' or (
                        ...
                        ramifications[j][0] = xEVAL(ramifications[j][0], E_i)

                    T[0], ramifications[j][0][0] = fp_cswap(
                        T[0], ramifications[j][0][0], b_i
                    )
                    T[1], ramifications[j][0][1] = fp_cswap(
                    ...
                    if setting.formulaes == 'tvelu' or (
                        ...
                        ramifications[j][1] = xEVAL(ramifications[j][1], E_i)

                    T[0], ramifications[j][1][0] = fp_cswap(
                        T[0], ramifications[j][1][0], b_i
                    )
                    T[1], ramifications[j][1][1] = fp_cswap(
