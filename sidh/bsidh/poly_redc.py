...
def reciprocal(f, flen, n):
    ...
    if n == 1:
        ...
        t2 = fp2_mul(t2, f[0])
        return (
            [fp2_mul(g[0], a), fp2_mul(g[1], a), fp2_sub([0, 0], t2)],
            fp2_sqr(a),
        )
        ...
        # Finally, the reciprocal is a*g - (f*g - a)*g mod x^n
        t = [fp2_mul(a, g[i]) for i in range(0, m, 1)] + [
            fp2_sub([0, 0], t[i]) for i in range(0, n - m, 1)
        ]
        # """
